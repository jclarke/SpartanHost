...
<table class="table table-striped table-framed">
    <thead>
        <tr>
            <th class="text-center">{$LANG.domaindnshostname}</th>
            <th class="text-center">{$LANG.domaindnsrecordtype}</th>
            <th class="text-center">{$LANG.domaindnsaddress}</th>
            <th class="text-center">{$LANG.domaindnspriority}</th>
        </tr>
    </thead>
    <tbody>
