...
<a class="btn btn-default pull-right" href="submitticket.php"><i class="icon-comment"></i> {$LANG.opennewticket}</a>
<div class="styled_title">
...
{foreach from=$invoices item=invoice}
        <tr>
            ...
            <td class="text-center"><a href="viewinvoice.php?id={$invoice.id}" target="_blank" class="btn">{$LANG.invoicesview}</a></td>
        </tr>
{foreachelse}
        <tr>
