            ...
            <div class="internalpadding">
                <table class="table table-striped table-framed table-centered">
                    ...
                    {foreach key=num item=addon from=$addons}
                        <tr>
                            <td>{$addon.name}</td>
                            <td class="text-center">{$addon.pricing}</td>
                            <td class="text-center">{$addon.nextduedate}</td>
                            <td class="text-center"><span class="label {$addon.rawstatus}">{$addon.status}</span></td>
                        </tr>
                    {foreachelse}
                        <tr>
