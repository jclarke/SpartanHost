...
<p class="text-center"><strong>{$noissuesmsg}</strong></p>
...
{foreach from=$servers key=num item=server}
        <tr>
            ...
            <td class="text-center" id="uptime{$num}"><img src="images/loadingsml.gif" alt="{$LANG.loading}" /><script> checkPort({$num},80); checkPort({$num},21); checkPort({$num},110); getStats({$num}); </script></td>
        </tr>
{foreachelse}
        <tr>
